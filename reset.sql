...
DROP
    TABLE IF EXISTS `NATION`;
DROP
    TABLE IF EXISTS `SAL_GRADE`;
...
VALUES
    ...
    (
        ...
        0.35,
        '100',
        STR_TO_DATE('97/09/12', '%y/%m/%d'),
        STR_TO_DATE('17/09/12', '%y/%m/%d'),
        'Y'
    );
